        ...
        <View style = {styles.container}>
            ...
            <View>
                <Text style = {{color : 'black', fontSize : 12 , fontWeight: "bold",
                 marginTop: 14}}> 786 Contacts </Text>
            </View>

            <View>
                <Text style = {{color : 'black', fontSize : 20 , fontWeight: "bold",
                 marginTop: 7}}> CONTACTS </Text>
            </View>
...
{/* //////////////////////////////////  NAME WITH COLOR LOGO  ////////////////////////////////////// */}
    ...
    <View>
        ...
        <View>
                <Text style = {{color : 'black', fontSize : 20 , fontWeight: "bold",
                 marginTop: 45, marginRight: 100}}> John Smith </Text>
        </View>

        <View style = {{alignItems : "center", alignContent : "center", marginTop: 45, 
            marginRight: 15}}>
                <Icon 
                type="feather"
                name = "plus"
